...
class MovingShape extends Thread{
	...
	public MovingShape(JFrame app) {
		...
		color = new Color((int)(Math.random()*128 + 128),
	...
	void draw(){
		...
		java.awt.Graphics g = app.getGraphics();
		switch (type) {
			case 0 :
				g.setColor(color);
				g.fillRect(x, y, w, h);
...
public class ThreadDrawJ extends JFrame
{
	...
	public static void main(String [] args) //ŒÓÈëmain,Ê¹Ö®ÄÜµ±ApplicationÓŠÓÃ
	{
